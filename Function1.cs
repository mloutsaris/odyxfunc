...
namespace odyxfunc
{
    public class Function1
    {
        ...
        public async Task<IActionResult> getblob([HttpTrigger(AuthorizationLevel.Anonymous, "get", "post")] HttpRequest req)
        {
            ...
            try
            {
                ...
                using (PdfDocumentProcessor pdfDocumentProcessor = new PdfDocumentProcessor())
                {
                    ...
                    AddBase64ImageToPdfPage(pdfDocumentProcessor, 0, base64Logo, 50, 50, 100, 100);
        ...
        private void AddBase64ImageToPdfPage(PdfDocumentProcessor pdfDocumentProcessor, int pageIndex, string base64Image, float x, float y, float width, float height)
        {
